...
<div class="whiteRect" role="none" bind:this={whiteRectElement} onmouseenter={show}></div>

<div class="conv-list" bind:this={convListElement} role="none" onmouseleave={hide}>
	<div class="title">All chats</div>

	<div class="reverse-list">
		{#each chatsState.chats as chat, idx (chat.messages)}
			<div
			...
			>
				<div class="message-preview">
					{extractTextFromHtml(chat.messages[chat.messages.length - 1].content as string)}
				</div>
			</div>
		{/each}
	</div>
