<div class="profile-container">
	<div class="profile-header">
		<picture>
			...
			<img class="profile-img" src="/moi.jpg" alt="Nathan Cassereau" loading="lazy" />
		</picture>
		<div class="profile-name">
			Nathan
			<span class="last-name"> Cassereau </span>
		</div>
	</div>
	...
	<div class="contact-info">
		<div class="contact-item">
			...
			<span class="contact-text"
				>Machine Learning Engineer <br />Artificial Intelligence Specialist</span
			>
		</div>
		...
		<div class="contact-item">
			<a
				...
				class="contact-link"
			>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98 96" class="contact-icon">
					<path
						fill-rule="evenodd"
						clip-rule="evenodd"
		...
		<div class="contact-item">
			<a
				...
				class="contact-link"
			>
				<svg viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg" class="contact-icon">
					<path
