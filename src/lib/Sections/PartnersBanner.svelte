<script lang="ts">
	...
	let logos = [
		...
		{
			url: '/Partners/ministere.svg',
			alt: "Ministères des finances / de la justice / de la transition écologique / de l'intérieur"
		},
...
<div class="partners-section">
	...
	>
		{#each logos as logo (logo.url)}
			<div class="logo-item">
				<img src={logo.url} alt={logo.alt} title={logo.alt} class="logo-image" draggable="false" />
			</div>
		{/each}

		<br />

		<div class="many-other">and many other...</div>
